...
class NewShopItem extends StatefulWidget {
  ...
  @override
  State<NewShopItem> createState() => NewShopItemState();
}

class NewShopItemState extends State<NewShopItem> {
                    ...
                    onPressed: () async {
                      ...
                      if (required) {
                        await createShopItem(
                            ...
                            stock.text == "" ? -1 : int.parse(stock.text),
                            emojiDisplay ?? "");
                  ...
                  Expanded(
                    child: TextField(
                        ...
                        inputFormatters: [
                          ...
                          MaxLengthNumberInputFormatter(9),
                        ],
