...
Future<void> updateShopItem(int rewardId, String name, int stock,
    String description, int price, String emoji) async {
...
'''),
  ...
  try {
    ...
    if (result.hasException) {
      ...
      AppLogger.info("Updated the item in the db: $variables");
    }
  } catch (e) {
    AppLogger.info(e);
  }
