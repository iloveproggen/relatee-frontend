...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  void _register() async {
    AppLogger.info('Register flow started.');
    setState(() {
      wrongPassword = false;
      timeOut = false;
      otherError = false;
    ...
    try {
      AppLogger.info('Sending register POST request.');
      response = await http
          .post(
    ...
    AppLogger.info('Register response status: ${response.statusCode}');
    if (response.statusCode == 200) {
      ...
      if (responseBody != null) {
              ...
              actions: [
                CupertinoDialogAction(
                  ...
                  onPressed: () async {
                    Get.back();
                    Get.back();
                    AppLogger.info('Registration success dialog closed.');
                  },
                ),
              ],
            );
        ...
        AppLogger.warning('Register response body was null.');
      }
      setState(() {
        isLoading = false;
      });
      ...
      AppLogger.warning('Register failed with status ${response.statusCode}');
      AppLogger.info('Register failure response: ${response.body}');
                            ...
                            suffixIcon: Padding(
                              ...
                              child: TextButton(
                                ...
                                child: Icon(
                                  ...
                                  color: const Color.fromARGB(255, 204, 198,
                                      196), // Set the color to grey
                                ),
                                onPressed: () {
                                  setState(() {
