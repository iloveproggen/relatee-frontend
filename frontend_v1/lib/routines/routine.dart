...
import 'package:frontend_v1/routines/routine_overview.dart';
...
Future<void> deleteRoutine(int id) async {
  ...
  AppLogger.info("deleting routine $id");
...
class _RoutineState extends State<Routine> {
  ...
  Widget build(BuildContext context) {
    ...
    AppLogger.info("all tasks??? $tasks");

    if (routines.isNotEmpty) {
      AppLogger.info(routines);
      return Column(
                    ...
                    routine['refreshDate'] != null
                        ? (routine['refreshDate'] is String
                            ? formatDateWithOrdinal(
                                DateTime.parse(routine['refreshDate']))
