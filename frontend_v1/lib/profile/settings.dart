      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child:
            ...
            useUserColor ? const SizedBox(height: 20) : const SizedBox(),
            useUserColor
                ? Container(
                    height: 15,
        ...
        actions: <Widget>[
          CupertinoActionSheetAction(
            ...
            onPressed: () async {
              ...
              Navigator.pop(context);
              AppLogger.info("changed language to German");
            },
          ),
          CupertinoActionSheetAction(
            ...
            onPressed: () async {
              ...
              if (!context.mounted) return;
              Navigator.pop(context);
              AppLogger.info("changed language to English");
            },
          ),
        ],
