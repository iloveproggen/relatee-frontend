...
import 'package:frontend_v1/household/household_invitation.dart';
import 'package:frontend_v1/profile/leader_board_v2.dart';
import 'package:frontend_v1/main.dart' as main;
import 'package:frontend_v1/profile/profile_v2.dart';
import 'package:frontend_v1/profile/profile_public.dart';
                          ...
                          child: SizedBox(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                ...
                                focusColor:
                                    main.userColor.withValues(alpha: 0.5),
                              ),
...
Future<void> queryKickUser(int id) async {
  ...
  if (result.hasException) {
    ...
    AppLogger.info("User was kicked.");
  }
}
...
class Member extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        // Icon(CupertinoIcons.person_fill, size: 50, color:main.userColor.withValues(alpha: 0.5),),
        // const SizedBox(width: 10),
        TextButton(
          style: ButtonStyle(
              animationDuration: Duration.zero,
