  ...
  Widget build(BuildContext context) {
    List<PageViewModel> introPages = [
      ...
      PageViewModel(
        ...
        body: "Add members to your household and assign them tasks.",
        image: const Center(
          child: Padding(
      ...
      PageViewModel(
        footer: Center(
            child: Text("made with love by rhinebytes",
        ...
        image: const Center(
          child: Padding(
            padding: EdgeInsets.only(top: 100.0),
            child:
                Text("ദ്ദി(˵ •̀ ᴗ - ˵ ) ✧", style: TextStyle(fontSize: 50.0)),
          ),
        ),
        decoration: PageDecoration(
          pageColor: Theme.of(context).colorScheme.primary,
    ...
    return Scaffold(
      body: IntroductionScreen(
        ...
        controlsPadding: const EdgeInsets.only(bottom: 50, left: 20, right: 20),
        dotsFlex: 2,
