...
Map<String, dynamic> nullRoutine = {'name': 'none', 'id': null, 'emoji': ""};
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: getHouseholdData(
          context), // Ensure this returns Future<List<Map<String, dynamic>>>
      builder:
...
class _DetailedTaskState extends State<DetailedTask> {
  ...
  void initState() {
    ...
    task['routineName'] != null
        ? pickedRoutine = {
            'name': task['routineName'],
            'id': task['routineId'],
            'emoji': task['routineEmoji']
          }
        : pickedRoutine = nullRoutine;
    AppLogger.info("pickedRoutine: $pickedRoutine");
  }
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                ...
                IconButton(
                  ...
                  onPressed: () async {
                    AppLogger.info(taskName.text);
                    AppLogger.info(taskPrice.text);
                    AppLogger.info(description.text);
                ...
                IconButton(
                  ...
                  onPressed: () async {
                    ...
                    AppLogger.info("deleted task");
                    Get.back();
                    AppLogger.info("updating now");
                    update();
                  },
            ...
            // ),
            Text(
                "created by ${task['ownerForename'] ?? task['ownerSurname'] ?? task['ownerUsername'] ?? 'user not found'}",
                style: Theme.of(context)
                    .textTheme
                    .bodySmall
                    ?.copyWith(color: userColor, fontWeight: FontWeight.bold)),
